                    ...
                    <form action="{{ route('admin.motor.update', $motor->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="harga" value="{{ old('harga', $motor->harga) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/\B(?=(\d{3})+(?!\d))/g, '.');" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Kilometer (Jarak Tempuh)</label>
                                <input type="text" class="form-control" name="kilometer" value="{{ old('kilometer', $motor->kilometer) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/\B(?=(\d{3})+(?!\d))/g, '.');" required>
                            </div>
                        </div>
